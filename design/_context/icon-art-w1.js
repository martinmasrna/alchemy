...
// Rock's pebbles, the Ocean's horizon, the star at the end of the Lightyear's tape.
...
const comet = box(`<defs>
  ...
  <circle cx="13" cy="35" r="2.8" fill="#FFFFFF"/>`);
...
const lava = box(`<defs><radialGradient id="la-m" cx=".5" cy=".45" r=".65">
  ...
  <g fill="#2A1B14" stroke="#4A2C1E" stroke-width=".5" stroke-linejoin="round">
    <path d="M6 31L12 25L19 27L18 34L9 37Z"/><path d="M20 26L28 23L31 30L24 34L19.5 33Z"/>
    <path d="M32 24L40 26L42 32L35 35L32.5 30Z"/><path d="M10 38.5L18.5 35.5L23 39L19 42L14 41Z"/>
    <path d="M24.5 35.5L31.5 31.5L34.5 36.5L29 41L24 40.5Z"/><path d="M36 36.5L42.5 33.5L39.5 39L35.5 40.5Z"/></g>
...
const BESPOKE = Object.fromEntries(Object.entries({
  star, energy, light, nebula, comet, supernova, stardust, blackhole, galaxy, lava, space,
